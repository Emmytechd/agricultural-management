...
?>
  ...
  <div class="row">
    <h3 class="title text-center bordered">Farm Weather Report  <?php //echo $current->city.' ('.$current->country.')';?></h3>
  ...
  <br><br>
  <div class="row">
    <h3 class="title text-center bordered">5 Days Farm Weather Forecast for  <?php //echo $current->city.' ('.$current->country.')';?></h3>
